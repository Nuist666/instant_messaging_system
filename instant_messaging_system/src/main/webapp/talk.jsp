...
<head>
	...
	<script type="text/javascript">
		...
		//定时发送请求  刷新页面
		window.setInterval("startRequest()", 100 );
...
<body style="background: url(images/background2.jpg);background-size:100% 100% ; background-attachment: fixed ">
    <div id="bigbox">
    	<div id="talkInfo">
   ...
   <button type="button" onclick="openNewPage()">文件传输</button>

    <script>
        // JavaScript函数，用于在按钮点击时打开另一个页面
        function openNewPage() {
            // 使用 window.location.href 跳转到另一个页面
            window.location.href = 'upload.jsp';
        }
    </script>
    				<input type="button" value=" &nbsp;退出聊天 &nbsp; " onclick="loginOut()"/>	 
    			</form>
    		</center>
    	</div>
    </div>
